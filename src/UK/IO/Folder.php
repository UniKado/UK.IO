<?php
/**
 * In this file the class '\UK\IO\Folder' is defined.
 *
...
abstract class Folder
{
    ...
    * e.g.:
    *
    * <code>\UK\IO\Folder::Up( '/is/var/www', 2, '' );   // results in: '/is'</code>
    *
    ...
    * @throws \UK\IO\IOException If creation fails
    */
    ...
    * @throws \UK\IO\IOException
    * @uses   \UK\IO\Folder::Copy() Uses internally the Copy method and clears after it the $sourceFolder
    */
    ...
    * @throws \UK\IO\FileAlreadyExistsException If the ZIP exists, and overwriting is disabled.
    * @throws \UK\IO\IOException                  In all other error cases, while ZIP writing.
    */
