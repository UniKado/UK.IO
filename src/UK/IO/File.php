<?php
/**
 * In this file the class '\UK\IO\File' is defined.
 *
 ...
 *
 * A instance can only be created by static {@see \UK\IO\File::CreateNew} and {@see \UK\IO\File::OpenRead}
 * methods.
 *
 * @since      v0.1
 */
class File
{
   ...
   /**
    * Creates a new file and returns the associated {@see \UK\IO\File} instance.
    *
    * If $overwrite is FALSE and the file already exists, a {@see \UK\IO\FileAlreadyExistsException} is thrown.
    *
    ...
    * @return \UK\IO\File                Returns the newly created File instance
    ...
    * returns the associated {@see \UK\IO\File} instance. If the file does not exist it will be created.
    *
    ...
    * @return \UK\IO\File                       Returns the File instance
    * @throws FileAccessException        On errors while opening the file pointer
    */
   ...
   /**
    * Opens a existing file for reading and returns the associated {@see \UK\IO\File} instance.
    *
    * @param  string  $file                The path of the file to read.
    * @param  boolean $lock                Use file locking? (default=FALSE)
    * @param  boolean $lockExclusive       If $lock is TRUE, use exclusive file locking? (default=FALSE)
    * @return \UK\IO\File                  Returns the newly created File instance
    * @throws \UK\IO\FileNotFoundException If the file not exists
    * @throws FileAccessException   On errors while opening the file pointer
    */
    ...
    * @throws \UK\IO\FileAlreadyExistsException If file exists and overwriting is disabled.
    * @throws FileAccessException        On errors while opening the file pointer
    */
    ...
    * {@see \UK\IO\FileAlreadyExistsException} is thrown.
    *
    ...
    * @throws \UK\IO\FileNotFoundException      If the $srcFile does not exist.
    * @throws \UK\IO\FileAlreadyExistsException If $targetFile exists and overwriting is disabled.
    * @throws \UK\IO\IOException
    */
    ...
    * otherwise a {@see \UK\IO\FileAlreadyExistsException} is thrown.
    *
    ...
    * @throws \Throwable
    * @throws \UK\\IO\FileAccessException If creating the ZIP file fails.
    * @throws \UK\IO\IOException
    */
    ...
    * @throws \UK\IO\FileNotFoundException  If the ZIP file dont exists.
